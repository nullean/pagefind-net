...
let private test (arguments:ParseResults<Arguments>) =
    exec "dotnet" ["run"; "--project"; "tests/Pagefind.Net.Tests/Pagefind.Net.Tests.csproj"; "-c"; "Release"] |> ignore
    exec "dotnet" ["run"; "--project"; "tests/Pagefind.Net.E2E.Tests/Pagefind.Net.E2E.Tests.csproj"; "-c"; "Release"] |> ignore
